...
from ..utils import solve_ode_second

router = APIRouter(prefix="/api/ode2", tags=["ode2"])
...
def solve(req: SolveRequest):
    ...
    print("solving")
    try:
        x, u = solve_ode_second(req.L, req.M, req.a, req.left_bc, req.right_bc, f_callable)
    except Exception as e:
