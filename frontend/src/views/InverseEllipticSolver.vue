    ...
    <div class="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
      ...
      <div :class="[
        ...
        <div class="mb-6 p-4 rounded-2xl bg-white/70 backdrop-blur-sm shadow-sm"
          ...
          <p>
            Уравнение Пуассона описывает установившееся распределение температуры,
...
async function solve() {
  ...
  try {
    const res = await axios.post("http://127.0.0.1:5000/api/inverse_elliptic1d/solve", params.value);
